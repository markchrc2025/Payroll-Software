/**
 * GET /api/payroll/runs/[id]/bank-files/landbank
 *
 * Downloads a Land Bank of the Philippines batch payroll credit file for a
 * FINALIZED payroll run.
 * Returns: text/plain with Content-Disposition: attachment
 * Filename: "landbank-payroll-YYYYMMDD.txt"
 */
...
import { formatLandbankFile } from "@/lib/payroll/bank-files/landbank";
...
export async function GET(
  ...
  try {
    ...
    const filename = `landbank-payroll-${y}${m}${d}.txt`;

    const content = formatLandbankFile({
