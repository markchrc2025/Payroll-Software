/**
 * GET /api/payroll/runs/[id]/bank-files/unionbank
 *
 * Downloads a UnionBank batch payroll credit CSV for a FINALIZED payroll run.
...
export async function GET(
  ...
  try {
    ...
    const filename = `unionbank-payroll-${y}${m}${d}.csv`;

    const content = formatUnionBankFile({
