/**
 * GET /api/payroll/runs/[id]/bank-files/bdo
 *
 * Downloads a BDO Unibank batch payroll credit file for a FINALIZED payroll run.
 * Returns: text/plain with Content-Disposition: attachment
 * Filename: "bdo-payroll-YYYYMMDD.txt"
 */
...
import { formatBdoFile } from "@/lib/payroll/bank-files/bdo";
...
export async function GET(
  ...
  try {
    ...
    const filename = `bdo-payroll-${y}${m}${d}.txt`;

    const content = formatBdoFile({
