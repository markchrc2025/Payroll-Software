  ...
  const created = await withTenant(auth.tenantId, (tx) =>
    tx.shiftSchedule.create({
      data: {
        ...
        coreTimeIn:         d.coreTimeIn         ?? null,
        coreTimeOut:        d.coreTimeOut        ?? null,
        requiredHours:      d.requiredHours      ?? null,
        gracePeriodMinutes: d.gracePeriodMinutes ?? 0,
        breakMinutes:       d.breakMinutes,
        breakPolicy:        d.breakPolicy,
        crossesMidnight:    d.crossesMidnight,
        workDays:           d.workDays,
        otThresholdMinutes: d.otThresholdMinutes ?? null,
        otRequiresApproval:  d.otRequiresApproval,
        otAutoApprove:       d.otAutoApprove,
        otBreakMode:         d.otBreakMode,
        otBreakTriggerHours: d.otBreakTriggerHours ?? null,
        otBreakBlockHours:   d.otBreakBlockHours   ?? null,
        otBreakMinutes:      d.otBreakMinutes       ?? null,
