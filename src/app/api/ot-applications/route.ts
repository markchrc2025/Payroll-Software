/**
 * GET /api/ot-applications
 *
 * HR/Admin list of all OT applications across employees (paginated).
 *
 * Query params:
...
export async function GET(req: NextRequest) {
  ...
  const where: Prisma.OTApplicationWhereInput = {
